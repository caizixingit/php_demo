        ...
        <div id="main">
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDlogistics_name" name="WIDlogistics_name" runat="server"></asp:TextBox>
                        <span>必填</span>
                    </dd>
                    <dt>物流发货单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDinvoice_no" name="WIDinvoice_no" runat="server"></asp:TextBox>
                        <span></span>
                    </dd>
                    <dt>物流运输类型：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDtransport_type" name="WIDtransport_type" runat="server"></asp:TextBox>
